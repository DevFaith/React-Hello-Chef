    ...
    <div className='bg-white'>
      <div className='max-w-7xl w-screen justify-center text-black p-12 mx-auto'>
        <div className='grid lg:grid-cols-3'>
          <div>
            <h2 className='mt-3 text-red-500 text-2xl md:text-3xl lg:4xl font-semibold '>HELLO<span className='text-black'>CHEF.</span></h2>
            <p className='text-xl mt-4'>Contact Us:</p>
          ...
          <div className='col-span-2 grid sm:grid-cols-3 mt-14 lg:mt-5 '>
            <div className='mt-14 sm:mt-0 justify-center text-center'>
              <h3 className='text-[16px] mb-3'>About Us:</h3>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
            ...
            <div className='mt-14 sm:mt-0 justify-center text-center'>
              <h3 className='text-[16px] mb-3'>More Info:</h3>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
            ...
            <div className='mt-14 sm:mt-0 justify-center text-center'>
              <h3 className='text-[16px] mb-3'>Our Blog:</h3>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >Our Plans</a>
              <a href="" className='block text-sm hover:underline hover:text-red-600 duration-300' >How it Works</a>
        ...
        <hr className='border-none mt-12 bg-black w-[100%] h-[1px]' />
        <div className=''>
          <p className='text-right'>Made with ❤️ for UAE</p>
